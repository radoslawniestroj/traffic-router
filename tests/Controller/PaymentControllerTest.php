...
final class PaymentControllerTest extends WebTestCase
{
    ...
    public function testInvalidMethodReturns405(): void
    {
        ...
        self::assertResponseStatusCodeSame(405); // oczekujemy Method Not Allowed
        self::assertTrue($client->getResponse()->headers->has('Allow'));
        self::assertStringContainsString('POST', $client->getResponse()->headers->get('Allow'));
    }
}
